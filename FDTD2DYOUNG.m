...
for t = 1:T-1
    ...
    for i = 1:siz
        for j = 1:siz-2
            ...
            if  ((i == 75 && ~(j > round(siz/2) - 5  && j < round(siz/2) + 5)) || ...
                    ((i == round(siz/2) && ~(j > round(siz/2) - 15 && j < round(siz/2) - 5) && ~(j > round(siz/2) + 5 && j < round(siz/2) + 15)))...
                    && ~(j > round(siz/2) - 35 && j < round(siz/2) - 25) && ~(j > round(siz/2) + 25 && j < round(siz/2) + 35))
                Hx(i, j + 1, t + 1) = 0;
            else
    ...
    for i = 1:siz-2
        for j = 1:siz
            ...
            if  ((i == 75 && ~(j > round(siz/2) - 5  && j < round(siz/2) + 5)) || ((i == round(siz/2) && ~(j > round(siz/2) - 15 && j < round(siz/2) - 5) && ~(j > round(siz/2) + 5 && j < round(siz/2) + 15))) && ~(j > round(siz/2) - 35 && j < round(siz/2) - 25) && ~(j > round(siz/2) + 25 && j < round(siz/2) + 35))
                Hy(i+1, j , t + 1) = 0;
            else
    ...
    for i = 2:siz-2
        for j = 2:siz-2
            ...
            if  ((i == 75 && ~(j > round(siz/2) - 5  && j < round(siz/2) + 5)) || ((i == round(siz/2) && ~(j > round(siz/2) - 15 && j < round(siz/2) - 5) && ~(j > round(siz/2) + 5 && j < round(siz/2) + 15))) && ~(j > round(siz/2) - 35 && j < round(siz/2) - 25) && ~(j > round(siz/2) + 25 && j < round(siz/2) + 35))
                ...
                if  t < 200 %i == 3 && (j > 102 && j < siz-302) && t < T/4 %((i >  siz - 8 && i < siz - 3 && j <= 199 && j < 201) && t * dt <= 8*(1/(4*f)) ) %((i> round(siz/2) -20 && i < round(siz/2) + 20 && j <= 4) && t < 16)
                    %
                    Ez(i, j, t + 1) = Ez(i, j , t+1) + (1/10000)*initcondGauss(x(i),y(j),-0.09,0.05,dt,0.002,0.002)*planeWave(0,0,0,0,dt,t+1,1,1,f*30,1000,0);
                    %
                end
            end
        end
